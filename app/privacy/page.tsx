        ...
        {[
          {
            ...
            content: [
              "The data controller responsible for the processing of your personal data is: Business Solutions Consulting EOOD, trading as GEO.app. Registered address: bul. Knyaz Aleksandar Dondukov 79, Floor 7, Apt. 7, Sofia 1504, Bulgaria. VAT: BG200487371.",
              "This Privacy Policy explains how we collect, use, store, and share your personal data when you use the GEO.app platform and related services. It complies with the EU General Data Protection Regulation (GDPR), the California Consumer Privacy Act (CCPA), and applicable Bulgarian data protection law.",
            ]
          },
          {
            num: "2",
            ...
            content: [
              "Account Data: When you register, we collect your name, email address, password (stored in hashed form), and subscription plan details.",
              ...
              "Usage Data: We collect information about how you use the platform, including domains you analyze, scan results, generated content, feature interactions, and session activity.",
              ...
              "Social/Business Data (No-Website Users): If you use our social presence analysis feature, we collect any Google Maps, Facebook, or Instagram URLs you provide voluntarily, along with your business description.",
              "Website Request Data: If you submit a request for website creation services, we collect your name, email, business description, and social profile links.",
            ]
          },
          {
            num: "3",
            ...
            content: [
              ...
              "Contractual Necessity (Art. 6(1)(b)): Processing your account data, subscription information, and usage data is necessary to provide the Services you have contracted for.",
          ...
          },
          {
            ...
            content: [
              ...
              "To generate AI-assisted content and analysis reports based on the domains and information you provide.",
          ...
          },
          {
            ...
            content: [
              ...
              "Supabase, Inc.: Database and authentication infrastructure. Data is stored on Supabase-hosted servers.",
              "Anthropic, PBC: AI content generation. Prompts containing business information you provide are processed by Anthropic's API. We do not share your personal account information with Anthropic.",
              "Vercel, Inc.: Platform hosting and deployment infrastructure.",
              "Legal Authorities: We may disclose data to competent authorities where required by applicable law, court order, or to protect GEO.app's legal rights.",
          ...
          },
          {
            ...
            content: [
              "Some of our service providers (including Stripe, Anthropic, and Vercel) are located in the United States. When we transfer your personal data outside the European Economic Area, we ensure appropriate safeguards are in place, including Standard Contractual Clauses approved by the European Commission.",
          ...
          },
          {
            ...
            content: [
              "Account data is retained for the duration of your subscription and for five (5) years thereafter, or as required by applicable law.",
              ...
              "Scan results and generated content are retained in accordance with your subscription plan's history limits.",
          ...
          },
          {
            ...
            content: [
              ...
              "Right to Erasure (Art. 17 GDPR): You may request deletion of your data in certain circumstances.",
              ...
              "California Residents (CCPA): You have the right to know what personal information is collected, the right to delete, the right to opt-out of sale (we do not sell data), and the right to non-discrimination.",
              "To exercise any of these rights, contact us at the address in Section 1. We will respond within thirty (30) days. You also have the right to lodge a complaint with the Bulgarian Commission for Personal Data Protection (CPDP) at www.cpdp.bg, or with your local supervisory authority.",
            ]
          },
          {
            num: "9",
          ...
          },
          {
            ...
            title: "Security",
            content: [
              "We implement commercially reasonable technical and organizational measures to protect your personal data, including encrypted data transmission (TLS), hashed password storage, access controls, and regular security assessments.",
          ...
          },
          {
            ...
            content: [
              "We may update this Privacy Policy from time to time. Material changes will be communicated via email or platform notification at least fourteen (14) days before taking effect. The current version will always be available at geo-ap.vercel.app/privacy.",
            ]
          },
          {
            num: "12",
            title: "Contact",
            content: [
              "For any privacy-related questions, requests, or concerns, please contact: Business Solutions Consulting EOOD (GEO.app), bul. Knyaz Aleksandar Dondukov 79, Floor 7, Apt. 7, Sofia 1504, Bulgaria. VAT: BG200487371.",
            ]
          },
        ].map(section => (
